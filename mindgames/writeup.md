...
1. We run a basic nmap scan against the target
...
2. We run a deeper nmap scan against the target
...
3. We enumerate the website for anything
...
4. We obtain a reverse shell using a manual exploit against the brainfuck python interpreter
# nc -nlvp 8000
...
6. We search the system for capabilities
# getcap -r / 2>/dev/null
...
7. Privilege escalation via capabilities
